...
while True:
    NomeFuncionario = str(input("Qual o seu primeiro nome?"))  # como incluir o nome nas horasextras e trabalhas
    if len(NomeFuncionario) > 1 and NomeFuncionario.isalpha():  # e como habilitar mais de um nome1
        break
